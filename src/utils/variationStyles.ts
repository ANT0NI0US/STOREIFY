...
export const VARIATION_STYLES: VariationStyles = {
  outline: {
    ...
    label:
      "peer-placeholder-shown:bg-transparent peer-focus:bg-light-color dark:peer-focus:bg-main-color peer-placeholder-shown:text-primary-color-light/40 dark:peer-placeholder-shown:text-primary-color/40 peer-focus:text-orange-color-light/70 dark:peer-focus:text-orange-color/70 peer-[&:not(:placeholder-shown)]:text-orange-color-light dark:peer-[&:not(:placeholder-shown)]:text-orange-color text-primary-color-light dark:text-primary-color absolute top-[12px] -translate-y-7 transform px-[1.5px] duration-300 peer-placeholder-shown:translate-y-0 peer-focus:-translate-y-7 peer-focus:px-[4px] left-[10px] peer-[&:not(:placeholder-shown)]:bg-light-color dark:peer-[&:not(:placeholder-shown)]:bg-main-color",
  },
  standard: {
    input:
