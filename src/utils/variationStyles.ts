...
export const VARIATION_STYLES: VariationStyles = {
  outline: {
    ...
    label:
      "peer-placeholder-shown:bg-transparent peer-focus:bg-secondary-light-color dark:peer-focus:bg-secondary-dark-color peer-placeholder-shown:text-text-light-color/55 dark:peer-placeholder-shown:text-primary-color/40 peer-focus:text-text-light-color/70 dark:peer-focus:text-orange-color/70 peer-[&:not(:placeholder-shown)]:text-text-light-color dark:peer-[&:not(:placeholder-shown)]:text-orange-color text-text-light-color dark:text-primary-color absolute top-[12px] -translate-y-7 transform px-[2px] duration-300 peer-placeholder-shown:translate-y-0 peer-focus:-translate-y-7 peer-focus:px-[4px] left-[10px] peer-[&:not(:placeholder-shown)]:bg-secondary-light-color dark:peer-[&:not(:placeholder-shown)]:bg-main-color",
  },
  standard: {
    input:
