...
export default function ProductCard({ item }: { item: newProductProps }) {
  ...
  return (
    <div className="flexBetween group hover:shadow-primary-color-light dark:hover:shadow-primary-color dark:bg-main-color relative flex-col overflow-hidden rounded-md bg-[#dac6aa] shadow-md drop-shadow-2xl transition-all duration-500 hover:shadow-2xl">
      {/* ADD TO FAVORITES */}
